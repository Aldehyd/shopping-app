...
interface ExitFromEditShopModalPropsInterface {
    navigation: NativeStackNavigationProp<any>,
    setDisplay: (value: boolean)=> void,
}

function ExitFromEditShopModal({navigation, setDisplay}: ExitFromEditShopModalPropsInterface): React.JSX.Element {
...
export default ExitFromEditShopModal;